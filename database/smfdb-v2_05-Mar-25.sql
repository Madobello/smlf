...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2025 at 01:17 PM
...
INSERT INTO `car` (`carid`, `carname`, `cartype`, `carmodel`, `country`, `Type`, `adminid`, `garagename`) VALUES
(1, 'BMW', 'Hybrid', 'Jeep', 'Germany', 'Automatic', 5, 'Atecar'),
(2, 'PRIUS', 'Electric (EV)', 'Toyota', 'Japan', 'Automatic', 5, 'Orange Garage'),
(3, 'Pajero', 'Diesel', 'Mitsubishi', 'Japan', 'Manual', 5, 'Luna Auto'),
(4, 'T-Cross', 'Diesel', 'Volkswagen', 'Germany', 'Manual', 5, 'Auto Express Garage'),
(5, 'Altis', 'Diesel', 'Toyota', 'Germany', 'Automatic', 5, 'AutoXpress'),
(6, 'Sonata', 'Diesel', 'Hundai', 'Germany', 'Automatic', 5, 'Gatsata Shop'),
(7, 'K5', 'Hybrid', 'KIA', 'Korea', 'Automatic', 5, 'AutoSpare'),
(8, 'Seoul', 'Hybrid', 'Jeep', 'Korea', 'Automatic', 5, 'Bello Auto'),
(9, 'Ferrari', 'Diesel', 'Fuel', 'England', 'Automatic', 5, 'Nyabugogo Garage'),
(13, 'Altis', 'EV', 'Toyota', 'N/A', 'Automatic', 5, 'Atecar');
