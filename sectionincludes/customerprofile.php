    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card border-primary">
                <div class="card-header bg-primary text-white text-center" style="padding: 8px;">
                    <h2>Your Profile</h2>
                </div>
                <div class="card-body">
<?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="phone" readonly title="Phoneno" pattern="^\+(\d{1,4})\s?\(?\d+\)?[\s\-]?\d+[\s\-]?\d+[\s\-]?\d+$" value="<?php echo htmlspecialchars($rowinfo['phone']); ?>" placeholder="Phone Number" required class="form-control">
                                </div>
