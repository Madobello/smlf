        ...
        <div class="collapse navbar-collapse " id="myNavbar">
            ...
            <ul class="nav navbar-nav">
                ...
                <li cclass="dropdown">
                    ...
                    ?>
                    <a href="#"  class="nav-link dropdown-toggle capitalize"  data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo nl2br($name); ?><span class="caret"></span></a>

                    <?php } else { ?>

                    <a href="#"  class="nav-link dropdown-toggle"  data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">GARAGE<span class="caret"></span></a>
                    ...
                    <ul class="dropdown-menu navbar-nav" aria-labelledby="navbarDropdown">
                        ...
                        <?php if(!isset($_SESSION['garageid'])) { ?>
                ...
                <li class="dropdown">
                    <?php
                        if(isset($_SESSION['customerid'])) {
                            ...
                            $phone=$_SESSION['phone'];
                    ?>
                    <a href="#"  class="nav-link dropdown-toggle capitalize"  data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo nl2br($lastname); ?><span class="caret"></span></a>
