    ...
    <div class="container">
        <div class="page-section">
            ...
            <!-- <div class="row"> -->
                <div class="col-md-3">
                    <div class="card">
                        ...
                        <div class="thumbnail text-center">
                            <img class="img" src="garageinfouploads/<?php echo $rowgarage['profileimg']; ?>"  style="height: 220px;">
                            <a href="#">
                ...
                <div class="col-md-4">
                    <p><a href="cargaragemoreinfopage.php?garageid=<?php echo $rowgarage['name']; ?>" class="btn btn-primary">Register Associate Car Services</a></p>
                </div>
                <?php $count++; } } else { ?>
